...
function parse_telegram($telegram) {
        ...
        $values = array(
                        ...
                        "1.4.0"=> array("name"=> "fluvius_unknown1", "unit"=> "kW", "value"=> "0", "type"=> "gauge", "help" => "Future use - unknown"),
                        "1.6.0"=> array("name"=> "fluvius_unknown2", "unit"=> "kW", "value"=> "0", "type"=> "gauge", "help" => "Future use - unknown"),
                        "98.1.0"=> array("name"=> "fluvius_unknown3", "unit"=> "String", "value"=> "", "type"=> "untyped", "help" => "Future use - messages from Fluvius"),
                        );
